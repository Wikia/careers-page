	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xxs-2 col-xs-2 col-sm-2 col-md-4 col-lg-4">
				<button class="btn-wikia" data-target="#jobApplyModal" data-toggle="modal">
					<?php _e( 'Apply', 'wikia-careers' ); ?>
				</button>
			</div>
...
<div class="modal fade job-offer-modal" id="jobApplyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<button type="button" class="go-back icon-arrow-left-gray" data-dismiss="modal" aria-hidden="true">
				<?php _e( 'Back', 'wikia-careers' ); ?>
			</button>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xxs-4 col-xs-4 col-sm-2 col-md-4 col-lg-4">
						<h2><?php _e( 'Fill out this form and send us your CV', 'wikia-careers' ); ?></h2>
					</div>
