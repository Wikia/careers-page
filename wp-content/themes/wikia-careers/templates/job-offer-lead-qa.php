<?php
/*
Template Name: Job offer Lead QA
*/
...
<article class="container spaced-container job-offer-content">
	<div class="row">
		<div class="col-xxs-4 col-xs-4 col-sm-4 col-md-8 col-lg-offset-1 col-lg-6 excerpt-col">
			<h2>Lubimy testy automatyczne</h2>
			<p>Wikia potrzebuje Twojej pomocy, by jeszcze skuteczniej wykorzystywać automatyzację testów w codziennej pracy. Ramię w ramię z Teamem QA i zespołami developerów twórz, rozwijaj procesy testowania w Wikii.</p>
		...
		<div class="col-xxs-4 col-xs-4 col-sm-2 col-md-4 col-lg-4 rail-col">
			...
			<ul>
				<li><strong>11&nbsp;000 – 13&nbsp;000 zł</strong> (brutto, na miesiąc)</li>
	...
	<div class="row">
		<div class="col-xxs-4 col-xs-4 col-sm-6 col-md-12 col-lg-10 col-lg-offset-1 job-offer-details">
			...
			<section class="featured-block">
				...
				<div class="columns">
					<ul>
						<li>planowania testów i tworzenia case’ów (manualnych i automatycznych)</li>
						...
						<li>mentoringu w zakresie automatyzacji testów</li>
						<li>bliskiej współpracy z developerami i product managerami</li>
					</ul>
				</div>
			</section>


			<h2>Czego potrzebujesz, aby być Liderem QA Teamu?</h2>
			<ul>
				<li>umiejętności pracy zespołowej</li>
				<li>doświadczenia w testowaniu serwisów internetowych</li>
				...
				<li>znajomości JavaScriptut, HTMLa, CSSa</li>
				...
				<li>doświadczenia w pracy w środowisku CI (Jenkins, Bamboo, CruiseControl)</li>
			</ul>

			<h2>Otrzymujesz bonusowe punkty za</h2>
			<ul>
				<li>Doświadczenie w testowaniu niefunkcjonalnym (performance, bezpieczeństwo, API, baza danych)</li>
